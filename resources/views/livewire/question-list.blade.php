    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-semibold text-gray-900">{{ $questions->count() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-semibold text-gray-900">{{ $questions->where('is_active', true)->count() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-semibold text-gray-900">{{ $questions->where('is_required', true)->count() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-semibold text-gray-900">{{ $questionTypes->count() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
        ...
        @if($questions->count() > 0)
            ...
            <div class="space-y-6 mb-8">
                ...
                <div wire:key="question-{{ $question->id }}" class="bg-white shadow-lg rounded-xl hover:shadow-2xl transition-all duration-300 border border-gray-200 hover:border-purple-200 {{ in_array($question->id, $selectedQuestions) ? 'ring-2 ring-purple-500 border-purple-300' : '' }}">
                    <div class="p-6">
                        <div class="flex items-start space-x-4">
                            <div class="flex-shrink-0 pt-1">
                                <input
                                    type="checkbox"
                                    wire:key="checkbox-{{ $question->id }}"
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center justify-between mb-3">
                                    <div class="flex items-center space-x-2">
                                        <h3 class="text-lg font-bold text-gray-900">{{ $question->name }}</h3>
                                ...
                                <p class="text-gray-700 mb-4 text-sm leading-relaxed">{{ $question->question_text }}</p>
            ...
            <form wire:submit.prevent="createQuestion" class="px-6 py-4 space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        @error('questionTypeId') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        @foreach($options as $index => $option)
                            <div class="flex items-center space-x-2">
                                <span class="flex-shrink-0 w-6 text-sm text-gray-500">{{ $index + 1 }}.</span>
                                <input
                                    type="text"
        ...
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white" wire:click.stop>
            <div class="mt-3 text-center">
                ...
                <p class="text-sm text-gray-500 mb-6">
                    Are you sure you want to delete "{{ $selectedQuestion->name }}"? This action cannot be undone.
                </p>
    ...
    <div class="fixed inset-0 bg-gray-600 bg-opacity-75 overflow-y-auto h-full w-full z-50 flex items-center justify-center" wire:click="closeModals">
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white" wire:click.stop>
            <div class="mt-3 text-center">
                ...
                <p class="text-sm text-gray-500 mb-6">
                    Are you sure you want to delete {{ count($selectedQuestions) }} selected question(s)? This action cannot be undone.
                </p>
                <div class="flex space-x-3">
                    <button
