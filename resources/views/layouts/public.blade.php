...
<head>
    ...
    <title>{{ $survey['name'] ?? 'Survey' }} - Survey Manager</title>
    ...
    <meta property="og:title" content="{{ $survey['name'] ?? 'Survey' }}">
    <meta property="og:description" content="{{ $survey['description'] ?? 'Complete this survey' }}">
        ...
        <footer class="bg-white border-t border-gray-200 mt-12">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div class="text-center text-sm text-gray-600">
                    <p>&copy; {{ date('Y') }} Survey Manager. All rights reserved.</p>
                </div>
            </div>
        </footer>
    </div>
