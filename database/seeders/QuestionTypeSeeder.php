    ...
    public function run(): void
    {
        $questionTypes = [
            ...
            [
                ...
                'configuration' => json_encode(['min_value' => 1, 'max_value' => 5, 'labels' => ['Poor', 'Fair', 'Good', 'Very Good', 'Excellent']]),
                'allows_images' => false,
                'allows_multiple_answers' => false,
                'is_active' => true,
            ],
            [
                ...
                'description' => 'Display text without requiring an answer',
                'configuration' => json_encode(['display_only' => true]),
                'allows_images' => true,
                'allows_multiple_answers' => false,
                'is_active' => true,
            ],
            ...
            [
                ...
                'configuration' => json_encode(['scale' => ['Strongly Disagree', 'Disagree', 'Neutral', 'Agree', 'Strongly Agree']]),
                'allows_images' => false,
                'allows_multiple_answers' => false,
                'is_active' => true,
            ],
